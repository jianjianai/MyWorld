...
public class v1_16_R3_userName implements PlayerDataSupport{
    File dataFile;
    public v1_16_R3_userName(File dataFile){
    ...
    public void saveData(Player player) {
        File file = new File(dataFile,player.getName());
        try {
    ...
    public PlayerDataLock getPlayerDataLock(Player player) {
        return new Lock(cn.jja8.myWorld.all.veryUtil.Lock.git(dataFile,player.getName()));
    }
