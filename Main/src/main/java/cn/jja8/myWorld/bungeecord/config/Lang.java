...
public class Lang {
    public   String 去出生点_所有服务器全满 = "服务器资源不够用了，请稍后再试。";
    public   String 创建世界_所有服务器全满 = "服务器资源不够用了，请稍后再试。";
    public   String 返回世界_所有服务器全满 = "服务器资源不够用了，请稍后再试。";
    public   String 返回世界_还没创建世界 = "你所在的团队还没创建世界哦。";
    public   String 返回世界_还没创建团队 = "你没有加入任何团队哦。";
