...
//import net.minecraft.server.v1_13_R1.Convertable;
...
//import net.minecraft.server.v1_13_R1.IProgressUpdate;
//import net.minecraft.server.v1_13_R1.MinecraftServer;
//import net.minecraft.server.v1_13_R1.ServerNBTManager;
//import net.minecraft.server.v1_13_R1.WorldData;
//import net.minecraft.server.v1_13_R1.WorldLoaderServer;
//import net.minecraft.server.v1_13_R1.WorldManager;
//import net.minecraft.server.v1_13_R1.WorldServer;
//import net.minecraft.server.v1_13_R1.WorldSettings;
...
//        }
//
//        Convertable converter = new WorldLoaderServer(worldContainer.toPath(), worldContainer.toPath().resolveSibling("../backups"), server.getHandle().getServer().dataConverterManager);
...
//
//        IDataManager sdm = new ServerNBTManager(worldContainer, name, server.getServer(), server.getHandle().getServer().dataConverterManager);
