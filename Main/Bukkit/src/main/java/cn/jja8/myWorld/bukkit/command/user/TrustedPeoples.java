...
public class TrustedPeoples implements CommandImplement , CanSetUp {
    @NeedSet public String 团队没有世界 = "你所在的团队没有世界";
    @NeedSet public String 信息 = "你所在的世界<世界>中，共有<数量>位信任玩家。分别是：<列表>";
    @NeedSet public String 你没有团队 = "你不在任何一个团队中。";
    @NeedSet public String 世界未加载 = "世界没有加载时无法查看信任玩家，请先进入你所在团队的世界。";
